## WooCommerce Restrictions — s2Member X Pro [![Build Status](https://travis-ci.org/websharks/woocommerce-s2member-x-pro.svg?branch=dev)](https://travis-ci.org/websharks/woocommerce-s2member-x-pro)
