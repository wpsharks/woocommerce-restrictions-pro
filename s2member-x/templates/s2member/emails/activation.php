...
<template-config file="emails/activation.php">
	<from_name><?php echo esc_html(get_bloginfo('name')); ?></from_name>
	<from_addr><?php echo esc_html(get_bloginfo('admin_email')); ?></from_addr>
	<subject><?php echo sprintf($this->translate('Activation Required (For: %1$s)'), esc_html(get_bloginfo('name'))); ?></subject>
...
<head>
	<meta charset="UTF-8" />
	<title><?php echo $this->translate('Activation Required'); ?></title>
