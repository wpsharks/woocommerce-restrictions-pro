...
<head>
	...
	<title><?php echo $this->translate('Account Activation'); ?> | <?php echo esc_html(get_bloginfo('name')); ?></title>
	...
	<div class="<?php echo esc_attr($this->stand_alone_container_classes()); ?>">
		...
		<div class="content wrapper">
			<div class="content container <?php echo esc_attr($this->ui_widget_classes()); ?>">
				...
				<a name="activation" class="anchor"></a>

				<h1><?php echo $this->translate('Account Activation'); ?></h1>
